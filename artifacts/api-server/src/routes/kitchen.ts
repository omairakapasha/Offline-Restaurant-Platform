...
router.get('/stats', requireSession, requireRole('kitchen'), asyncHandler(async (req: Request, res: Response) => {
  ...
  // Revenue only counts completed (served) orders.
  ...
  // Admins see revenue; kitchen staff get operational counts only.
